...
every instance of this chart at once: kubectl get pods -n mcp -l app=postgres-mcp
*/}}
...
{{- printf "%s-%s" (include "postgres-mcp.name" .) (.Values.instance | toString) | trunc 63 | trimSuffix "-" -}}
{{- else -}}
...
app.kubernetes.io/instance: {{ include "postgres-mcp.fullname" . }}
{{- end -}}

{{- define "postgres-mcp.labels" -}}
app: {{ include "postgres-mcp.name" . }}
