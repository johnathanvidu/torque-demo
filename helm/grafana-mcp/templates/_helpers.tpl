...
every instance of this chart at once: kubectl get pods -n mcp -l app=grafana-mcp
*/}}
...
{{- printf "%s-%s" (include "grafana-mcp.name" .) (.Values.instance | toString) | trunc 63 | trimSuffix "-" -}}
{{- else -}}
